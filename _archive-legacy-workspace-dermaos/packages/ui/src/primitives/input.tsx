        ...
        <div className="relative flex items-center">
          ...
          <input
            ...
            className={cn(
              ...
              error && 'border-danger-500 hover:border-danger-500 focus-visible:ring-danger-500 focus-visible:border-danger-500',
              success && !error && 'border-success-500 hover:border-success-500 focus-visible:ring-success-500',
              className,
            )}
            {...props}
          />
