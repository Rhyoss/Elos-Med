  ...
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      `flex cursor-default gap-2 select-none items-center rounded-sm px-2 py-1.5 text-sm
       outline-none focus:bg-hover data-[state=open]:bg-hover
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      `z-[--z-dropdown] min-w-[8rem] overflow-hidden rounded-md border bg-popover p-1
       text-popover-foreground shadow-lg animate-fade-in`,
      className,
    )}
  ...
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      `relative flex cursor-default select-none items-center gap-2 rounded-sm px-2 py-1.5 text-sm
       ...
       [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0`,
      inset && 'pl-8',
      destructive && 'text-danger-500 focus:bg-danger-100 focus:text-danger-500',
      className,
    )}
    {...props}
  />
...
export {
  DropdownMenuRoot,
  // Alias compatível com a convenção shadcn/ui
