...
export type IcoName =
  | 'grid' | 'calendar' | 'user' | 'users' | 'message' | 'box' | 'creditCard'
  | 'barChart' | 'settings' | 'plus' | 'edit' | 'more' | 'search' | 'alert'
...
export function Ico({ name, size = 18, color = 'currentColor', sw = 1.7, className, style }: IcoProps) {
  ...
  const I: Record<IcoName, React.ReactElement> = {
