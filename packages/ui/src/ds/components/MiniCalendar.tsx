...
export interface MiniCalendarProps {
  ...
  selectedDay: number;
  /** Today (highlighted distinctly from selected day). Optional. */
  today?: { year: number; month: number; day: number };
  /** Set of day numbers (1-31) within `month` that have appointments — render dot. */
  apptDays?: ReadonlySet<number>;
              ...
              {hasAppt && (
                <div
                  style={{
                    ...
                    height: 3,
                    borderRadius: '50%',
                    background: isSelected ? T.primary : T.clinical.color,
                    flexShrink: 0,
                  }}
                />
              )}
